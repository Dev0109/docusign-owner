...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddUserResponseAccountProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddUserResponseAccountProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.DocusignAdmin) {
      root.DocusignAdmin = {};
    }
    root.DocusignAdmin.AddUserResponse = factory(root.DocusignAdmin.ApiClient, root.DocusignAdmin.AddUserResponseAccountProperties);
  }
}(this, function(ApiClient, AddUserResponseAccountProperties) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accounts')) {
        obj['accounts'] = ApiClient.convertToType(data['accounts'], [AddUserResponseAccountProperties]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/AddUserResponseAccountProperties>} accounts
   */
