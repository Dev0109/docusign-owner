...
(function(root, factory) {
  ...
  var exports = function(optsOrCallback) {
     ...
     */
    this.basePath = optsOrCallback.basePath;
     ...
     * @default https://www.docusign.net/restapi
     */
    this.oAuthBasePath = optsOrCallback.oAuthBasePath;
  ...
  exports.prototype.getJWTUri = function(clientId, redirectURI, oAuthBasePath) {
    return "https://" + oAuthBasePath + "/oauth/auth" + "?" +
      ...
      "scope=" + encodeURIComponent("signature impersonation organization_monitor_config_read organization_monitor_config_write organization_monitor_events_read") + "&" +
      "redirect_uri=" + encodeURIComponent(redirectURI);
  };
