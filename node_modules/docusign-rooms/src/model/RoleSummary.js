...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DocusignRooms.RoleSummary = factory(root.DocusignRooms.ApiClient);
  }
  ...
  /**
   * The RoleSummary model module.
   * @module model/RoleSummary
   */

  /**
   * Constructs a new <code>RoleSummary</code>.
   * @alias module:model/RoleSummary
   * @class
   */
  ...
  /**
   * Constructs a <code>RoleSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RoleSummary} obj Optional instance to populate.
   * @return {module:model/RoleSummary} The populated <code>RoleSummary</code> instance.
   */
