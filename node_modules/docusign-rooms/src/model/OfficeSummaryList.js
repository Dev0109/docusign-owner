...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OfficeSummary'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OfficeSummary'));
  } else {
    // Browser globals (root is window)
    if (!root.DocusignRooms) {
      root.DocusignRooms = {};
    }
    root.DocusignRooms.OfficeSummaryList = factory(root.DocusignRooms.ApiClient, root.DocusignRooms.OfficeSummary);
  }
}(this, function(ApiClient, OfficeSummary) {
  'use strict';


  /**
   * The OfficeSummaryList model module.
   * @module model/OfficeSummaryList
   */

  /**
   * Constructs a new <code>OfficeSummaryList</code>.
   * @alias module:model/OfficeSummaryList
   * @class
   */
  ...
  /**
   * Constructs a <code>OfficeSummaryList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OfficeSummaryList} obj Optional instance to populate.
   * @return {module:model/OfficeSummaryList} The populated <code>OfficeSummaryList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('officeSummaries')) {
        obj['officeSummaries'] = ApiClient.convertToType(data['officeSummaries'], [OfficeSummary]);
      }
  ...
  /**
   * @member {Array.<module:model/OfficeSummary>} officeSummaries
   */
  exports.prototype['officeSummaries'] = undefined;
  /**
